        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFFFCFAF2), // Cozy cream/parchment background
              ...
              boxShadow: const [
                ...
                BoxShadow(
                  color:
                      Color(0x337AA2B8), // Soft blue glow shadow from the image
                  blurRadius: 16,
                  spreadRadius: 2,
                ),
              ],
                  ...
                  child: Row(
                    children: [
                      ...
                      AppHugeIcon(
                        ...
                        color: Color(0xFF708E9E), // Slate blue icon
                        size: 22,
                      ),
                    ],
                  ),
            ...
            child: RotationTransition(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  border: Border(
                    bottom: BorderSide(color: Color(0xFF1E2732), width: 1.8),
