...
extension NetworkExceptionsPatterns on NetworkExceptions {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UnauthorizedRequest() when unauthorizedRequest != null:
        return unauthorizedRequest(_that);
      case BadRequest() when badRequest != null:
        return badRequest(_that);
      case Forbidden() when forbidden != null:
        return forbidden(_that);
      case ForbiddenRequest() when forbiddenRequest != null:
        return forbiddenRequest(_that);
      ...
      case BadCertificate() when badCertificate != null:
...
class ForbiddenRequest implements NetworkExceptions {
  const ForbiddenRequest();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ForbiddenRequest);
  }
...
class BadCertificate implements NetworkExceptions {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BadCertificate);
  }
