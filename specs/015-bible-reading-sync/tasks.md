...
- [x] T001 Initialize feature branch and PR draft in repo root: `specs/015-bible-reading-sync/plan.md`
- [x] T002 [P] Add Firebase RTDB dependency to Flutter project: `pubspec.yaml`
- [x] T003 Create RTDB rules draft file: `specs/015-bible-reading-sync/contracts/rtdb-rules.json`
- [x] T004 [P] Add placeholder UI routes and screens: `lib/app/features/study_rooms/README.md`

Phase 2: Foundational (blocking prerequisites)

- [x] T005 Implement `StudyRoom` data model classes: `lib/app/models/study_room.dart`
- [x] T006 Implement `VerseReference` and resolver interfaces: `lib/app/core/verse_resolver.dart`
- [x] T007 Create `StudyRoomService` RTDB integration (join/publish/presence): `lib/app/services/study_room_service.dart`
- [x] T008 [P] Add unit tests for `VerseReference` lookup and mapping: `test/core/verse_resolver_test.dart`
- [x] T009 Implement RTDB security rules (draft): `specs/015-bible-reading-sync/contracts/rtdb-rules.json`
- [x] T010 Update CI/README with RTDB emulation instructions: `specs/015-bible-reading-sync/quickstart.md`
...
- [x] T011 [US1] Implement event model and writer for `ShareEvent` to RTDB: `lib/app/services/study_room_service.dart`
- [x] T012 [US1] Implement RTDB listener to receive `ShareEvent` and enqueue apply logic: `lib/app/services/study_room_service.dart`
- [x] T013 [US1] Map incoming `verseRef` → local lookup → compute scroll offset: `lib/app/core/verse_resolver.dart`
- [x] T014 [US1] Apply scroll & highlight UI logic on verse apply: `lib/app/features/study_rooms/study_room_view.dart`
...
- [x] T019 [US2] Add UI control `FollowHostToggle` to detach/reattach: `lib/app/features/study_rooms/widgets/follow_host_toggle.dart`
...
- [x] T021 [US3] Implement `StudyRoomsList` UI and RTDB query for public rooms: `lib/app/features/study_rooms/study_rooms_list.dart`
- [x] T022 [US3] Implement `StudyRoomView` join flow and presence updates: `lib/app/features/study_rooms/study_room_view.dart`
...
- [ ] T025 [US3] Update `quickstart.md` with discovery usage and manual invite flow: `specs/015-bible-reading-sync/quickstart.md`

Final Phase: Polish & cross-cutting

- [ ] T026 [P] Add logging and diagnostics UI for sync attempts: `lib/app/features/study_rooms/debug/sync_log_view.dart`
- [ ] T027 [P] Add metrics dashboards (local/remote) to measure latency and failures: `specs/015-bible-reading-sync/metrics.md`
- [ ] T028 [P] Run pilot and collect acceptance metrics; create pilot report: `specs/015-bible-reading-sync/pilot-report.md`
- [ ] T029 [P] Accessibility and localization review for new UI strings: `lib/l10n/` and `specs/015-bible-reading-sync/quickstart.md`
- [ ] T030 [P] Prepare PR with documentation and migration notes: `specs/015-bible-reading-sync/plan.md`
