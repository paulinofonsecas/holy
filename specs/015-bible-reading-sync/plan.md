...
Next Actions (short)
--------------------
1. Create design artifacts (data-model, contracts, quickstart). 2. Run agent-context updater. 3. Open PR branch `015-bible-reading-sync/plan` with artifacts. 4. Start implementation tasks.
