...
**Input**: specs/001-multiple-search-joins/

## Phase 1: Setup
- [ ] T001 [P] Confirm feature docs aligned (spec/plan/research) in specs/001-multiple-search-joins/plan.md
...
- [ ] T015 [P] Refresh quickstart with validation steps for AND/OR joins in specs/001-multiple-search-joins/quickstart.md
