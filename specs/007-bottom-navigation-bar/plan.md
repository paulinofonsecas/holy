...
**Branch**: `007-bottom-navigation-bar` | **Date**: 2026-01-02 | **Spec**: [spec.md](spec.md)
**Input**: Feature specification from `/specs/007-bottom-navigation-bar/spec.md`
...
```text
specs/007-bottom-navigation-bar/
├── plan.md              # This file
